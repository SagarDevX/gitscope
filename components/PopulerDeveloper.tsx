            ...
            <div className="mx-auto mt-12 grid max-w-fit grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
                ...
                {loading
                    ? usernames.map((username) => (
                        <div
                            key={username}
                            className="h-[400px] animate-pulse rounded-3xl bg-brandBlack"
                        />
                    ))
    ...
    return (
        <motion.div className="group flex min-h-100 flex-col rounded-3xl border border-brandBlack bg-[#faf6ee] p-6 transition-all duration-500 hover:-translate-y-1 hover:border-brand hover:bg-brandBlack hover:text-neutral-400 w-72 ">
            ...
            >
                ...
                <p className="mt-1 text-sm text-brandBlack group-hover:text-neutral-400">
                    {developer.name || "GitHub Developer"}
                </p>

                <p className="mt-4 line-clamp-3 min-h-[72px] text-sm leading-6 text-neutral-500 group-hover:text-white/70">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 border-y border-black/10 py-5 group-hover:border-white/10">
                ...
                transition={{
                    ...
                    <div className="flex items-center gap-2 text-brandBlack group-hover:text-neutral-500">
                        <IconUsers size={16} />
